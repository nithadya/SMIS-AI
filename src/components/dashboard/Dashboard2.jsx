    ...
    const kpiGroups = [
      {
        ...
        metrics: [
          { key: 'inquiryToApplication', label: 'Inquiry to Application', icon: '📝' },
          { key: 'applicationToEnrollment', label: 'Application to Enrollment', icon: '✅' },
      ...
      },
      {
        ...
        metrics: [
          { key: 'resourceUtilization', label: 'Resource Utilization', icon: '📊' },
          { key: 'teacherStudentRatio', label: 'Teacher-Student Ratio', icon: '👥' },
          { key: 'classOccupancyRate', label: 'Class Occupancy', icon: '🏫' },
          { key: 'facilityUtilization', label: 'Facility Utilization', icon: '🏢' }
        ]
      },
      {
        title: 'Marketing',
        ...
        metrics: [
          ...
          { key: 'costPerAcquisition', label: 'Cost per Acquisition', icon: '💰' },
